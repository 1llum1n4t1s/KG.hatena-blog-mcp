/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --env-interface Env --strict-vars=false` (hash: 5e9090830daa7e9b06ba7aa194c1cc42)
// Runtime types generated with workerd@1.20260415.1 2026-08-24 enable_request_signal,nodejs_compat,request_signal_passthrough
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./adapters/cloudflare/index");
	}
	interface Env {

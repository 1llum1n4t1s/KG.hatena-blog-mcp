...
- MCPの入力検証、ビルド、テスト、コード品質検査に使う依存関係を最新の安定版へ更新

### Security

- MCP SDKが利用する推移的依存関係を更新し、既知のサービス拒否脆弱性を解消
...
## [0.0.1] — Git 記録日: 2026-04-19

- 開発ツール・設定・テスト用データを含む初期構成を追加。

出典: [版の記録](https://github.com/1llum1n4t1s/KG.hatena-blog-mcp/commit/d33a7e6ad1e1d1ebe82d7cb889f4e86e737d3a7d)。
